...
class MediumController extends Controller
{
    ...
    {
        if (\request()->ajax()) {
            $query = MediumModel::where('is_deleted',0)->get(); // You can modify this query as needed
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $standard = MediumModel::updateOrCreate(
    ...
    public function destroy(string $id)
    {
        //real delete
        // try {
        //     $standard = MediumModel::findOrFail($id);
        //     $standard->delete();
        ...
        //soft delete
        try {
            $updatedRows = MediumModel::where('id', $id)->update(['is_deleted' => 1]);
