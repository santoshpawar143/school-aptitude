...
class RoleController extends Controller
{
    ...
    {
        if (\request()->ajax()) {
            $query = RoleModel::where('is_deleted',0)->get(); // You can modify this query as needed
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $standard = RoleModel::updateOrCreate(
    ...
    public function destroy(string $id)
    {
        //real
        // try {
        //     $standard = RoleModel::findOrFail($id);
        //     $standard->delete();
        ...
        // soft
        try {
            $updatedRows = RoleModel::where('id', $id)->update(['is_deleted' => 1]);
