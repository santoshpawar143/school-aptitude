                            ...
                            <div class="modal-body">
                                <form id="chapterForm">
                                    ...
                                    <div class="mb-3 ">
                                        ...
                                        <select class="form-select form-select-lg custom-rounded" name="chapter_board"
                                            id="chapter_board">
                                    ...
                                    <div class="mb-3 ">
                                        ...
                                        <select class="form-select form-select-lg custom-rounded" name="chapter_medium"
                                            id="chapter_medium">
                                    ...
                                    <div class="mb-3 ">
                                        ...
                                        <select class="form-select form-select-lg custom-rounded" name="chapter_standard"
                                            id="chapter_standard">
                                    ...
                                    <div class="mb-3 ">
                                        ...
                                        <select class="form-select form-select-lg custom-rounded" name="chapter_subject"
                                            id="chapter_subject">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type='text' class="form-control form-control-lg custom-rounded"
                                            name='chapter_name' id='chapter_name' />
                                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="mb-3 col-sm-2 ">
                                    <label for="chapter_board" class="form-label">Board</label>
                                    <select class="form-select form-select custom-rounded" name="filter_chapter_board"
                                ...
                                <div class="mb-3 col-sm-2 ">
                                    <label for="chapter_medium" class="form-label">Medium</label>
                                    <select class="form-select form-select custom-rounded" name="filter_chapter_medium"
                                ...
                                <div class="mb-3 col-sm-2 ">
                                    <label for="chapter_medium" class="form-label">Standard</label>
                                    <select class="form-select form-select custom-rounded" name="filter_chapter_standard"
                                ...
                                <div class="mb-3 col-sm-2 ">
                                    <label for="chapter_medium" class="form-label">subject</label>
                                    <select class="form-select form-select custom-rounded" name="filter_chapter_subject"
                                        id="filter_chapter_subject">

                                    </select>
                                </div>
                                <div class="mb-3 col-sm-2  align-self-center">
                                    <button type="button" id='chapter_filter' class="btn pro-btn">
                                        search
                                    </button>
                                </div>
                            </div>
