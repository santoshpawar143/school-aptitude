                    ...
                    <div class="col-12">
                        <div class="card recent-sales overflow-auto">
                                            ...
                                            <form id="standardForm">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="standard_name"
                                                        name="standard_name" required placeholder="Enter standard name">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="user_email"
                                                        name="user_email" required placeholder="Enter Email">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="user_password" class="form-label"
                                                        id='user_label_password'>Password</label>
                                                    <input type="text" class="form-control" id="user_password"
                                                        name="user_password" required placeholder="Enter Password">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="user_role" class="form-label">Role</label>
                                                    <select class="form-select form-select" name="user_role" id="user_role">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="user_school"
                                                        name="user_school" required placeholder="Select School">
                            ...
                            <div class="card-body">
                                ...
                                <table id="standardTable" class="table">
                                    <thead>
                                        <tr>
