                                            ...
                                            <form id="resultForm">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="hidden" class="form-control" id="result_id"
                                                        name="result_id">
                                                    <input type="text" class="form-control" id="result_roll_no"
                                                        name="result_name" required placeholder="Enter Roll No">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="result_name" class="form-label">Marks Obtained</label>

                                                    <input type="text" class="form-control" id="result_marks_obtained"
                                                        name="result_name" required placeholder="Enter Marks Obtained">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="result_name" class="form-label">Total Marks</label>
                                                    <input type="text" class="form-control" id="result_total_marks"
                                                        name="result_name" required placeholder="Enter Total Marks">
                                                </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="mb-3 col-sm-2 ">
                                        ...
                                        <select class="form-select form-select" name="filter_result_board"
                                    ...
                                    <div class="mb-3 col-sm-2 ">
                                        ...
                                        <select class="form-select form-select" name="filter_result_medium"
                                    ...
                                    <div class="mb-3 col-sm-2 ">
                                        ...
                                        <select class="form-select form-select" name="filter_result_standard"
                                    ...
                                    <div class="mb-3 col-sm-2 ">
                                        ...
                                        <select class="form-select form-select" name="filter_result_subject"
                                    ...
                                    <div class="mb-3 col-sm-2">
                                        ...
                                        <select class="form-select form-select" name="filter_result_chapter"
